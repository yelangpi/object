...
bool StartScene::init()
{
	...
	closeItem->getSelectedImage()->setScale(0.7);
	...
	settingsItem->getSelectedImage()->setScale(0.7);
	...
	prepareItem->getSelectedImage()->setScale(0.7);
	...
	prepareItem2->getSelectedImage()->setScale(0.7);
